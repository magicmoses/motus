ALTER TABLE enrichments
  ADD COLUMN IF NOT EXISTS movement_practices text[] DEFAULT '{}';

CREATE INDEX IF NOT EXISTS enrichments_movement_practices_idx
  ON enrichments USING GIN (movement_practices);

-- Rebuild view to include movement_practices
